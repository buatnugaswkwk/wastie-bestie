export const load = {
  ...
  assets: () => {
    ...
    loadSprite("trash-icon-fix", "./assets/trash-icon-fix.png")
    loadSprite("star-icon", "./assets/Stars_Ui.png")
    loadSprite("trash", "./assets/trash-fix.png")
    loadSprite("logo", "./assets/LOGO-WASTIE-BESTIE.png")
    loadSprite("player", "./assets/player-test.png", {
      sliceX: 4,
      sliceY: 6,
      anims: {
        idle: {
  ...
  sounds: () => {
    ...
    loadSound("trash", "./sounds/coin.wav")
